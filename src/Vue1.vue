<template>
  <div>
    ...
    >
      ...
      <template>
        <Option v-for="(item, index) in select.content" :content="item" :key="index">
          <template>
            <span>123</span>
            <span>-</span>
    ...
    <h2 class="mt10">Switch开关</h2>
    <SwitchUI
      :config="switchObj.config">
    </SwitchUI>
    <h2 class="mt10">Slider滑块</h2>
    <Slider
      :config="slider.config">
    </Slider>
    <h2 class="mt10">Cascader级联选择器</h2>
    <Cascader
    ...
    <h2 class="mt10">Card卡片</h2>
    <Card
      :config="card.config">
      <div>Card卡片</div>
    </Card><h2 class="mt10">Collapse折叠面板</h2>
    <cbf-collapse
      :config="collapse.config">
      <cbf-collapse-item :content="collapse.content[0]">
        <template #title>
      ...
      <cbf-collapse-item :content="collapse.content[1]">
        <template>
          <div>控制反馈：通过界面样式和交互动效让用户可以清晰的感知自己的操作；</div>
          <div>页面反馈：操作后，通过页面元素的变化清晰地展现当前状态。</div>
        </template>
      </cbf-collapse-item>  
      <cbf-collapse-item :content="collapse.content[2]">
        <template>
      ...
      <cbf-collapse-item :content="collapse.content[3]">
        <template>
    ...
    return {
      ...
      select: {
        ...
        content: [
          { label: "测试1", value: 1 },
          { label: "测试2", value: 2 },
          { label: "测试3", value: 3, disabled: true },
          { label: "测试4", value: 4 },
        ],
      },
      // Switch开关
